...
These definitions are consistent with the Claerbout/Donoho/Peng convention (group $B1$)---even though  in economics and political science `replicability` has been widely used as an umbrella term.
...
The Federation of American Societies for Experimental Biology published a recommendations document \cite[]{faseb2016} targeted at biomedical and biological research (particularly two key tools: mouse models and antibodies). It defines:
\begin{description}
